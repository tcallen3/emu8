...
CXXFLAGS += -Waggregate-return -Wcast-align -Wcast-qual -Wconversion
CXXFLAGS += -Wdisabled-optimization -Wfloat-equal -Wformat=2 -Wformat-nonliteral
CXXFLAGS += -Wformat-security -Wformat-y2k -Wimplicit -Wimport -Winit-self
...
LDEXTRA := -fsanitize=address -static-libasan
#LDEXTRA := -flto
